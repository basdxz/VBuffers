...
public final class PrimitiveAccessors implements Accessors {
    ...
    @GetterAccessor.Immutable.Accessor({char.class, Character.class})
    ...
    @SetterAccessor.Accessor({short.class, Short.class})
    ...
    @GetterAccessor.Immutable.Accessor({short.class, Short.class})
    ...
    @SetterAccessor.Accessor({int.class, Integer.class})
    ...
    @GetterAccessor.Immutable.Accessor({int.class, Integer.class})
    ...
    @SetterAccessor.Accessor({long.class, Long.class})
    ...
    @GetterAccessor.Immutable.Accessor({long.class, Long.class})
    ...
    @SetterAccessor.Accessor({float.class, Float.class})
    ...
    @GetterAccessor.Immutable.Accessor({float.class, Float.class})
    ...
    @SetterAccessor.Accessor({double.class, Double.class})
    ...
    @GetterAccessor.Immutable.Accessor({double.class, Double.class})
